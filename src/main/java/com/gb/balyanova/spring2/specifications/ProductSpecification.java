...
public class ProductSpecification {
    ...
    public static Specification<Product> categoryEqual(String categoryPart) {
        return (Specification<Product>) (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.equal(root.get("category").get("title"), categoryPart);
    }
}
